...
class FundsDistributions extends StatefulWidget {
  const FundsDistributions({super.key});

  @override
  _FundsDistributionsState createState() => _FundsDistributionsState();
}

class _FundsDistributionsState extends State<FundsDistributions> {
  int selectedIndex = -1;
